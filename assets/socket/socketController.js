...
export const socket = io("rive-animation-backend-production.up.railway.app");
export const ioSocket = socket.connect("rive-animation-backend-production.up.railway.app");
