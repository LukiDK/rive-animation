...
export const socket = io("https://rive-animation-backend-production.up.railway.app");
export const ioSocket = socket.connect("https://rive-animation-backend-production.up.railway.app");
